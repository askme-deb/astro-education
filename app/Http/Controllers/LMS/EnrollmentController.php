...
class EnrollmentController extends Controller
{
    ...
    {
        $response = $this->enrollmentApiService->listEnrollments();
        $items = $this->enrollmentApiService->extractEnrollmentItems($response);

        $enrollments = array_map(function (array $enrollment): array {
        ...
        return view('enrollments.index', [
            ...
            'apiError' => !empty($response['success']) ? null : ($response['error'] ?? null),
        ]);
    }
